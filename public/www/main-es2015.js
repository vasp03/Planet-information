...
const routes = [
    ...
    {
        path: 'merkurius',
        loadChildren: () => __webpack_require__.e(/*! import() | merkurius-merkurius-module */ "merkurius-merkurius-module").then(__webpack_require__.bind(null, /*! ./merkurius/merkurius.module */ "./src/app/merkurius/merkurius.module.ts")).then(m => m.MerkuriusPageModule)
    },
    {
        path: 'venus',
        loadChildren: () => __webpack_require__.e(/*! import() | venus-venus-module */ "venus-venus-module").then(__webpack_require__.bind(null, /*! ./venus/venus.module */ "./src/app/venus/venus.module.ts")).then(m => m.VenusPageModule)
    },
    {
        path: 'jorden',
        loadChildren: () => __webpack_require__.e(/*! import() | jorden-jorden-module */ "jorden-jorden-module").then(__webpack_require__.bind(null, /*! ./jorden/jorden.module */ "./src/app/jorden/jorden.module.ts")).then(m => m.JordenPageModule)
    },
    {
        path: 'mars',
        loadChildren: () => __webpack_require__.e(/*! import() | mars-mars-module */ "mars-mars-module").then(__webpack_require__.bind(null, /*! ./mars/mars.module */ "./src/app/mars/mars.module.ts")).then(m => m.MarsPageModule)
    },
    {
        path: 'jupiter',
        loadChildren: () => __webpack_require__.e(/*! import() | jupiter-jupiter-module */ "jupiter-jupiter-module").then(__webpack_require__.bind(null, /*! ./jupiter/jupiter.module */ "./src/app/jupiter/jupiter.module.ts")).then(m => m.JupiterPageModule)
    },
    {
        path: 'saturnus',
        loadChildren: () => __webpack_require__.e(/*! import() | saturnus-saturnus-module */ "saturnus-saturnus-module").then(__webpack_require__.bind(null, /*! ./saturnus/saturnus.module */ "./src/app/saturnus/saturnus.module.ts")).then(m => m.SaturnusPageModule)
    },
    {
        path: 'uranus',
        loadChildren: () => __webpack_require__.e(/*! import() | uranus-uranus-module */ "uranus-uranus-module").then(__webpack_require__.bind(null, /*! ./uranus/uranus.module */ "./src/app/uranus/uranus.module.ts")).then(m => m.UranusPageModule)
    },
    {
        path: 'neptunus',
        loadChildren: () => __webpack_require__.e(/*! import() | neptunus-neptunus-module */ "neptunus-neptunus-module").then(__webpack_require__.bind(null, /*! ./neptunus/neptunus.module */ "./src/app/neptunus/neptunus.module.ts")).then(m => m.NeptunusPageModule)
    },
    {
        path: 'pluto',
        loadChildren: () => __webpack_require__.e(/*! import() | pluto-pluto-module */ "pluto-pluto-module").then(__webpack_require__.bind(null, /*! ./pluto/pluto.module */ "./src/app/pluto/pluto.module.ts")).then(m => m.PlutoPageModule)
    },
];
...
module.exports = __webpack_require__(/*! C:\Users\viktor.asp2\Documents\github project\vasp03\Planet-information\src\main.ts */"./src/main.ts");
